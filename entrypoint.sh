...
if [ $PROJECT_STATUS -eq $STATUS_FAIL ]; then
  echo "Code analysis failed. Contact technical support https://phpsecure.net/" >&2
  exit 0
fi
...
VIEW_URL="https://phpsecure.net/personal/projects/$PROJECT_UUID/$SECURITY_CHECK_UUID"
echo " "
echo " "
